...
::Make Directories
mkdir C:\Iris >nul 2>&1
mkdir C:\Iris\Resources >nul 2>&1
mkdir C:\Iris\Revert >nul 2>&1
mkdir C:\Iris\Drivers >nul 2>&1
cd C:\Iris
...
>nul 2>&1 call "C:\Iris\Revert\firstlaunch.bat"
...
set date1=%date:/=.%
>nul 2>&1 md C:\Iris\Revert\%date1%
reg export HKCU C:\Iris\Revert\%date1%\HKLM.reg /y >nul 2>&1
reg export HKCU C:\Iris\Revert\%date1%\HKCU.reg /y >nul 2>&1
echo set firstlaunch=0 > C:\Iris\Revert\firstlaunch.bat
...
(
	...
	::MSI AfterBurner
	if not exist "C:\Program Files (x86)\MSI Afterburner\Skins\Iris.usf" set "AFTOF=%COL%[91mOFF"
	::PStates0
	...
	Reg query "HKCU\Software\Iris" /v "NpiTweaks" || set "NPIOF=%COL%[91mOFF"
	::Nvidia Tweaks
	Reg query "HKCU\Software\Iris" /v "NvidiaTweaks" || set "NVIOF=%COL%[91mOFF"
	::Memory Optimization
	Reg query "HKCU\Software\Iris" /v "MemoryTweaks" || set "ME2OF=%COL%[91mOFF"
	::Network Internet Tweaks
	Reg query "HKCU\Software\Iris" /v "InternetTweaks" || set "NETOF=%COL%[91mOFF"
	::Services Tweaks
	Reg query "HKCU\Software\Iris" /v "ServicesTweaks" || set "SERVOF=%COL%[91mOFF"
	::Nagle Tweaks
	Reg query "HKLM\Software\Microsoft\MSMQ\Parameters" /v "TCPNoDelay" | find "0x1" || set "NAGOF=%COL%[91mOFF"
	::Debloat Tweaks
	Reg query "HKCU\Software\Iris" /v "DebloatTweaks" || set "DEBOF=%COL%[91mOFF"
	::Mitigations Tweaks
	Reg query "HKCU\Software\Iris" /v "MitigationsTweaks" || set "MITOF=%COL%[91mOFF"
	::Affinities
	Reg query "HKCU\Software\Iris" /v "AffinityTweaks" || set "AFFOF=%COL%[91mOFF"
	::Mouse Fix
	...
	::BCDEDIT
	Reg query "HKCU\Software\Iris" /v "BcdEditTweaks" || set "BCDOF=%COL%[91mOFF"
	::NIC
	if not exist "%SystemDrive%\Iris\HoneRevert\ognic.reg" set "NICOF=%COL%[91mOFF"
	::Intel iGPU
...
curl -g -L -o "C:\Iris\Resources\HoneV2.pow" "https://github.com/auraside/HoneCtrl/raw/main/Files/HoneV2.pow" >nul 2>&1
powercfg /d 44444444-4444-4444-4444-444444444449 >nul 2>&1
powercfg -import "C:\Iris\Resources\HoneV2.pow" 44444444-4444-4444-4444-444444444449 >nul 2>&1
...
if "%BCDOF%" equ "%COL%[91mOFF" (
	Reg add "HKCU\Software\Iris" /v BcdEditTweaks /f
	::tscsyncpolicy
	...
	Reg delete "HKCU\Software\Iris" /v "BcdEditTweaks" /f
	::Better Input
...
if "%TMROF%" equ "%COL%[91mOFF" (
	if not exist SetTimerResolutionService.exe (
		...
		curl -g -L -o "C:\Iris\Resources\SetTimerResolutionService.exe" "https://github.com/auraside/HoneCtrl/raw/main/Files/SetTimerResolutionService.exe" >nul 2>&1
...
:NIC
cd %SystemDrive%\Iris\HoneRevert
...
reg export "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%a" "C:\Iris\Revert\ognic.reg" /y
::Disable Keys w "*"
...
if "%NETOF%" equ "%COL%[91mOFF" (
	Reg add "HKCU\Software\Iris" /v InternetTweaks /f
	...
	Reg delete "HKCU\Software\Iris" /v InternetTweaks /f
	netsh winsock reset catalog
	netsh int ip reset c:resetlog.txt
	netsh int ip reset C:\tcplog.txt	
...
if "%DEBOF%" equ "%COL%[91mOFF" (
    Reg add "HKCU\Software\Iris" /v DebloatTweaks /f
    ...
    Reg delete "HKCU\Software\Iris" /v DebloatTweaks /f
...
if "%MITOF%" equ "%COL%[91mOFF" (
	Reg add "HKCU\Software\Iris" /v MitigationsTweaks /f
	...
	Reg delete "HKCU\Software\Iris" /v MitigationsTweaks /f
...
:MSIAfterBurner
if "%AFTOF%" neq "%COL%[91mOFF" (del /S /Q /F "%SystemDrive%\Program Files (x86)\MSI Afterburner\Skins\Iris.usf" >nul 2>&1) && goto Tweaks
if not exist "%SystemDrive%\Program Files (x86)\MSI Afterburner\MSIAfterburner.exe" goto downloadMSIafterburner
curl -g -L -o "C:\Program Files (x86)\MSI Afterburner\Skins\Iris.usf" "https://github.com/auraside/HoneCtrl/raw/main/Files/Iris.usf" >nul 2>&1
goto Tweaks
:downloadMSIafterburner
echo Downloading MSIAfterBurner
curl -g -L -o "C:\Iris\Resources\MSI_Afterburner.zip" "https://github.com/auraside/HoneCtrl/releases/download/2.0/MSI.Afterburner_2.zip" >nul 2>&1
powershell Expand-Archive 'C:\Iris\Resources\MSI_Afterburner.zip' -DestinationPath 'C:\Program Files (x86)'
...
del /Q /F "%SystemDrive%\Iris\Resources\MSI_Afterburner_1.zip" >nul 2>&1
goto MSIAfterBurner

:ProfileInspector
if "%NPIOF%" equ "%COL%[91mOFF" (
	Reg add "HKCU\Software\Iris" /v NpiTweaks /f
	rmdir /S /Q "C:\Iris\Resources\nvidiaProfileInspector\"
	curl -g -L -o C:\Iris\Resources\nvidiaProfileInspector.zip "https://github.com/Orbmu2k/nvidiaProfileInspector/releases/latest/download/nvidiaProfileInspector.zip"
	powershell -NoProfile Expand-Archive 'C:\Iris\Resources\nvidiaProfileInspector.zip' -DestinationPath 'C:\Iris\Resources\nvidiaProfileInspector\'
	del /F /Q "C:\Iris\Resources\nvidiaProfileInspector.zip"
...
::https://github.com/Orbmu2k/nvidiaProfileInspector/releases/latest/download/nvidiaProfileInspector.zip
	Reg delete "HKCU\Software\Iris" /v NpiTweaks /f
	rmdir /S /Q "C:\Iris\Resources\nvidiaProfileInspector\"
	curl -g -L -o C:\Iris\Resources\nvidiaProfileInspector.zip "https://github.com/Orbmu2k/nvidiaProfileInspector/releases/latest/download/nvidiaProfileInspector.zip"
	powershell -NoProfile Expand-Archive 'C:\Iris\Resources\nvidiaProfileInspector.zip' -DestinationPath 'C:\Iris\Resources\nvidiaProfileInspector\'
	del /F /Q "C:\Iris\Resources\nvidiaProfileInspector.zip"
...
choice /c:YN /n /m "[Y] Yes  [N] No"
if %errorlevel% equ 1 (
curl -L -o "C:\Iris\Drivers\NvidiaHone.exe" "https://github.com/auraside/HoneCtrl/releases/download/1.3/497.09.Hone.Default.exe"
) else (
curl -L -o "C:\Iris\Drivers\NvidiaHone.exe" "https://github.com/auraside/HoneCtrl/releases/download/1.3/497.09.Hone.Tweaked.exe"
)

TITLE Executing DDU...
curl -g -L -o "C:\Iris\Resources\DDU.zip" "https://github.com/auraside/HoneCtrl/raw/main/Files/DDU.zip"
powershell -NoProfile Expand-Archive 'C:\Iris\Resources\DDU.zip' -DestinationPath 'C:\Iris\Resources\DDU\' >nul 2>&1
del "C:\Iris\Resources\DDU.zip"
cd C:\Iris\Resources\DDU
...
cls
Reg add "HKCU\Software\Iris" /v "NvidiaTweaks" /f
...
Reg delete "HKCU\Software\Iris" /v "NvidiaTweaks" /f
::Enable Hardware Accelerated Scheduling
...
if "%SERVOF%" equ "%COL%[91mOFF" (
    Reg add "HKCU\Software\Iris" /v ServicesTweaks /f
    ...
    Reg delete "HKCU\Software\Iris" /v ServicesTweaks /f   
...
if "%AFFOF%" neq "%COL%[91mOFF" (
	Reg delete "HKCU\Software\Iris" /v AffinityTweaks /f >nul 2>&1
...
Reg add "HKCU\Software\Iris" /v AffinityTweaks /f >nul 2>&1
...
if "%ME2OF%" equ "%COL%[91mOFF" (
	Reg add "HKCU\Software\Iris" /v "MemoryTweaks" /f
	...
	Reg delete "HKCU\Software\Iris" /v MemoryTweaks /f
...
:Cleaner
cls
rmdir /S /Q "C:\Iris\Resources\DeviceCleanupCmd\"
del /F /Q "C:\Iris\Resources\AdwCleaner.exe"
del /F /Q "C:\Iris\Resources\EmptyStandbyList.exe"
curl -g -L -o "C:\Iris\Resources\EmptyStandbyList.exe" "https://wj32.org/wp/download/1455/"
curl -g -L -o "C:\Iris\Resources\DeviceCleanupCmd.zip" "https://www.uwe-sieber.de/files/DeviceCleanupCmd.zip"
curl -g -L -o "C:\Iris\Resources\AdwCleaner.exe" "https://adwcleaner.malwarebytes.com/adwcleaner?channel=release"
powershell -NoProfile Expand-Archive 'C:\Iris\Resources\DeviceCleanupCmd.zip' -DestinationPath 'C:\Iris\Resources\DeviceCleanupCmd\'
del /F /Q "C:\Iris\Resources\DeviceCleanupCmd.zip"
...
cd "C:\Iris\Resources\DeviceCleanupCmd\x64"
...
%SYSTEMROOT%\System32\WindowsPowerShell\v1.0\powershell.exe Checkpoint-Computer -Description 'Iris Restore Point' >nul 2>&1
for /F "tokens=2" %%i in ('date /t') do set date=%%i
set date1=%date:/=.%
md C:\Iris\Revert\%date1%
reg export HKCU C:\Iris\Revert\%date1%\HKLM.reg /y & reg export HKCU C:\Iris\Revert\%date1%\HKCU.reg /y >nul 2>&1
cls
goto More
